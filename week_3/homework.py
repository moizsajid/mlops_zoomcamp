...
def main(date=None):
    ...
    train_path: str = f"http://nyc-tlc.s3.amazonaws.com/trip+data/fhv_tripdata_{train_year}-{train_month}.parquet"
    val_path: str = f"http://nyc-tlc.s3.amazonaws.com/trip+data/fhv_tripdata_{val_year}-{val_month}.parquet"
